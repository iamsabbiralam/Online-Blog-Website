                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <a href="{{ route('admin.addpost') }}" class="btn btn-primary" style="float:right">Add
                                    New Post</a>
                            </div>
                            <!-- /.card-header -->
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $p->view }}</td>
                                            <td>
                                                <a href="{{ route('admin.editpost', [ 'id' => $p->id ]) }}"><i
                                                        class="fas fa-edit"></i></a> |
                                                <a href="javascript:confirmation<?php echo $p->id; ?>()"><i
                                                    ...
                                                    function confirmation<?php echo $p->id; ?>() {
                                                        ...
                                                        if (answer) {
                                                            //alert("Entry Deleted")
                                                            window.location =
                                                                "{{ route('admin.destroypost', [ 'id' => $p->id ]) }}";
                                                        } else {}
                                                    }
                                                    </script>
                                            </td>
