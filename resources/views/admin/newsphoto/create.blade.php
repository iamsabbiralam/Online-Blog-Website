...
@section('page_title', 'Add News Photo')
@section('container')
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Add New News Photo</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
	            <div class="card card-primary">
	              <!-- /.card-header -->
	              <!-- form start -->
	              <form action="{{ route('admin.pronewsphoto') }}" method="post" enctype="multipart/form-data">
	              	@csrf
	                <div class="card-body">
	                  ...
	                  <div class="form-group">
	                    ...
	                    <textarea class="form-control" name="details" placeholder="Enter Details" rows="5" cols="10"></textarea>
	                  </div>
	                  <div class="form-group">
	                    <label for="reporter">Reporter</label>
	                    <input type="text" class="form-control" name="reporter" placeholder="Enter Reporter Name">
	                  </div>
	                </div>
	                <!-- /.card-body -->
