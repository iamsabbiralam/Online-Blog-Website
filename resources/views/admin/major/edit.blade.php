...
@section('page_title', 'Edit Major News')
@section('container')
	            ...
	            <div class="card card-primary">
	              ...
	              <form action="{{ route('admin.updatenews', [ 'id' => $news->id ]) }}" method="post" enctype="multipart/form-data">
	                ...
	                <div class="card-body">
	                    ...
	                    <img src="{{ asset('storage/app/public/images/post/'.$news->image) }}" alt="image" width="100px">
	                  </div>
	                  <div class="form-group">
	                    <label for="image">Image</label>
	                  ...
	                  <div class="form-group">
	                    ...
	                    <input type="text" class="form-control" name="sub_title" value="{{ $news->sub_title }}">
	                  </div>
	                 	 @php
	                  ...
	                  <div class="form-group">
	                    ...
	                    <select required="" class="form-control" name="cat_id">
	                        ...
	                        <option value="{{ $category->id }}" @if($news->cat_id == $category->id) selected
	                  ...
	                  <div class="form-group">
                        ...
                        <option value="{{ $sub_category->id }}" @if($news->sub_id == $sub_category->id) selected
	                  ...
	                  <div class="form-group">
	                    ...
	                    <textarea class="form-control" name="details" placeholder="Enter Details" rows="5" cols="10">{{ $news->details }}</textarea>
	                  </div>
	                  <div class="form-group">
	                    <label for="reporter">Reporter</label>
	                    <input type="text" class="form-control" name="reporter" value="{{ $news->reporter }}">
	                  </div>
	                </div>
	                <!-- /.card-body -->
